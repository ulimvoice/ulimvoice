(function (global) {
  ...
  if (global.__ULIM_STAFF_LOGIN_FIREBASE_PRIMARY_7326__) return;
  global.__ULIM_STAFF_LOGIN_FIREBASE_PRIMARY_7326__ = true;

  const VERSION = '2026-08-01.732.05';
  ...
  async function firebasePrimaryAdminLogin() {
    ...
    loginPromise = (async function () {
      ...
      try {
        ...
        safeConsole('info', '[ULIM 7.32.5 legacy migration fallback]', text(firebaseError && firebaseError.code));
  ...
  global.__ULIM_STAFF_LOGIN_FIREBASE_PRIMARY_7325_API__ = Object.freeze({
    version: VERSION,
