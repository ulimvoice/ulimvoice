(function (global) {
  ...
  if (global.__ULIM_STAFF_FIRESTORE_OPERATIONAL_73113__) return;
  global.__ULIM_STAFF_FIRESTORE_OPERATIONAL_73113__ = true;

  const VERSION = '2026-08-01.731.13';
  const CACHE_PREFIX = 'ulim_staff_fsop_73113_';
  ...
  safeConsole('info', '[ULIM staff Firestore operational 7.31.13 attendance/daily clear]', VERSION);
