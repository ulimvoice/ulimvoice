(function (global) {
  ...
  if (global.__ULIM_ATTENDANCE_ADMIN_INTEGRATED_735413__) return;
  global.__ULIM_ATTENDANCE_ADMIN_INTEGRATED_735413__ = true;
  global.__ULIM_ATTENDANCE_ADMIN_INTEGRATED_735410__ = true;
  global.ULIM_ATTENDANCE_ADMIN_INTEGRATED_VERSION = '2026-08-07.735.04.13-restored';

  var VERSION = '2026-08-07.735.04.13-restored';
  var loadSequence = 0;
  ...
  function preloadWholeClass735413() {
    if (!isFullAdmin() || allClassesState735410.directory) return;
  ...
  function install() {
    ...
    scheduleDecorate(0);
    setTimeout(preloadWholeClass735413, 120);
  ...
  global.addEventListener('ulim-firebase-auth-ready', function () { setTimeout(function(){ install(); preloadWholeClass735413(); }, 60); });
