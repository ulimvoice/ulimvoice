(function (global) {
  ...
  if (global.__ULIM_STAFF_FIRESTORE_OPERATIONAL_73115__) return;
  global.__ULIM_STAFF_FIRESTORE_OPERATIONAL_73115__ = true;

  const VERSION = '2026-08-01.731.15';
  const CACHE_PREFIX = 'ulim_staff_fsop_73115_';
