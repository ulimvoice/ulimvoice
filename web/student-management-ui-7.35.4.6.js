(function (global) {
  ...
  if (global.__ULIM_STUDENT_MANAGEMENT_UI_73546__) return;
  global.__ULIM_STUDENT_MANAGEMENT_UI_73546__ = true;

  const VERSION = '2026-08-04.735.04.6';
  ...
  const DRAFT_KEY = 'ulim_notice_message_draft_73546';
  ...
  function install() {
    ...
    const legacyRefresh = document.getElementById('adminRefreshStudentsBtn');
    if (legacyRefresh) legacyRefresh.style.display = 'none';
