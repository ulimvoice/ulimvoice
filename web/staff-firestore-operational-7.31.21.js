(function (global) {
  ...
  if (global.__ULIM_STAFF_FIRESTORE_OPERATIONAL_73121__) return;
  ...
  const VERSION = '2026-08-07.731.21.0-firestore-only-class-list';
...
function currentStatusEdited73115(row) {
  ...
  global.adminLoadAttendanceSnapshot = async function (showAlert, forceSheetSync) {
    ...
    global.__ULIM_ATTENDANCE_NO_AUTO_REFRESH_73121__ = true;
