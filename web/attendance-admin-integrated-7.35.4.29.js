(function (global) {
  ...
  if (global.__ULIM_ATTENDANCE_ADMIN_INTEGRATED_735429__) return;
  ...
  global.ULIM_ATTENDANCE_ADMIN_INTEGRATED_VERSION = '2026-08-10.735.04.29-wholeclass-canonical-roster-convergence';

  var VERSION = '2026-08-10.735.04.29-wholeclass-canonical-roster-convergence';
  var loadSequence = 0;
  ...
  function ledgerMonthBlockHtml735427(group, monthKey, sessions, kind) {
    ...
    var safeSessions = Array.isArray(sessions) ? sessions : [];
    // Each month owns its own roster. A student who only existed in the previous
    // month must not remain as a disabled row in the current-month table.
  ...
  function install() {
    global.__ULIM_ATTENDANCE_SINGLE_OWNER_7355016__ = 'attendance-admin-integrated-7.35.4.29';
    global.__ULIM_ATTENDANCE_SINGLE_OWNER_7355015__ = 'attendance-admin-integrated-7.35.4.29';
    global.__ULIM_ATTENDANCE_SINGLE_OWNER_7355014__ = 'attendance-admin-integrated-7.35.4.29';
