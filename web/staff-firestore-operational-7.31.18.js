(function (global) {
  ...
  if (global.__ULIM_STAFF_FIRESTORE_OPERATIONAL_73118__) return;
  global.__ULIM_STAFF_FIRESTORE_OPERATIONAL_73118__ = true;

  const VERSION = '2026-08-06.731.18.0-attendance-duplicate-guard-delta';
  const CACHE_PREFIX = 'ulim_staff_fsop_73118_';
