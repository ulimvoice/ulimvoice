(function (global) {
  ...
  if (global.__ULIM_ATTENDANCE_ADMIN_INTEGRATED_735415__) return;
  ...
  global.ULIM_ATTENDANCE_ADMIN_INTEGRATED_VERSION = '2026-08-07.735.04.15-canonical-roster-single-owner';

  var VERSION = '2026-08-07.735.04.15-canonical-roster-single-owner';
  var loadSequence = 0;
    ...
    allClassesState735410.loadingPromise = (async function () {
      try {
        ...
        var tempPromise = (!dateValue || (!force && allClassesState735410.temporaryDate === dateValue))
          ...
          : call('getAttendanceRosterAdmin73550', { date: dateValue, className: '전체반', keyword: '', statusFilter: '', requestId: requestId('all-classes-attendance-735410') });
