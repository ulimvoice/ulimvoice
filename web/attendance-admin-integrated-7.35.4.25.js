(function (global) {
  ...
  if (global.__ULIM_ATTENDANCE_ADMIN_INTEGRATED_735425__) return;
  ...
  global.ULIM_ATTENDANCE_ADMIN_INTEGRATED_VERSION = '2026-08-09.735.04.25-table-interaction-owner';

  var VERSION = '2026-08-09.735.04.25-table-interaction-owner';
  var loadSequence = 0;
  ...
  async function runtime() {
    ...
    if (typeof room.getStableIdToken === 'function') await room.getStableIdToken(rt, false, 'attendance-admin-integrated-735425');
  ...
  function bindAllClassesHeaderControls735425(modal) {
    if (!modal || modal.dataset.ulimHeaderControls735425 === '1') return;
    modal.dataset.ulimHeaderControls735425 = '1';
    modal.addEventListener('click', function (event) {
      ...
      if (target.id === 'ulimAllClassesReload735423') {
        event.preventDefault();
        event.stopPropagation();
        loadAllClassesData735410(true).catch(function () {});
        return;
      }
  ...
  function renderTeacherTabs735423() {
    ...
    if (wrap.dataset.ulimTeacherTabs735425 !== '1') {
      wrap.dataset.ulimTeacherTabs735425 = '1';
  ...
  async function saveLedgerCell735423(group, student, session, patch) {
    ...
    allClassesState735410.actionInFlight = true;
    try {
      await call('saveAttendanceRowsAdmin73550', { rows: [payload], requestId: requestId('ledger-attendance-save-735425') });
  ...
  function bindLedgerEvents735423() {
    ...
    if (!board || board.dataset.ulimLedgerDelegation735425 === '1') return;
    board.dataset.ulimLedgerDelegation735425 = '1';
  ...
  function openAllClassesModal735410() {
    ...
    loadAllClassesData735410(!allClassesState735410.ledger).catch(function () {});
  }
  ...
  function ensureLedgerStyles735425() {
    ...
    if (document.getElementById('ulim-attendance-ledger-style-735425')) return;
    var style = document.createElement('style');
    style.id = 'ulim-attendance-ledger-style-735425';
    style.textContent = ''
  ...
  function install() {
    global.__ULIM_ATTENDANCE_SINGLE_OWNER_7355016__ = 'attendance-admin-integrated-7.35.4.25';
    global.__ULIM_ATTENDANCE_SINGLE_OWNER_7355015__ = 'attendance-admin-integrated-7.35.4.25';
    global.__ULIM_ATTENDANCE_SINGLE_OWNER_7355014__ = 'attendance-admin-integrated-7.35.4.25';
