(function (global) {
  ...
  if (global.__ULIM_STAFF_FIRESTORE_OPERATIONAL_73119__) return;
  global.__ULIM_STAFF_FIRESTORE_OPERATIONAL_73119__ = true;

  const VERSION = '2026-08-07.731.19.0-firebase-primary-class-catalog-fallback';
  const CACHE_PREFIX = 'ulim_staff_fsop_73119_';
...
function attendanceMinimal(row) {
  ...
  async function legacyClassListForDate(date, force) {
    if (!token() || typeof adminApi !== 'function') return [];
    try {
