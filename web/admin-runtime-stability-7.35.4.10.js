(function (global) {
  ...
  function ensureAllClassesStyles735411() {
    ...
    style.textContent = [
      '#ulimAllClassesBoard735410{display:grid!important;grid-template-columns:none!important;grid-auto-flow:column!important;grid-auto-columns:minmax(320px,360px)!important;align-items:start!important;align-content:start!important;gap:14px!important;overflow:auto!important;padding:14px!important}',
      '#ulimAllClassesBoard735410>.ulim-all-teacher-column735411{min-width:320px;max-width:360px;width:100%;box-sizing:border-box;border:1px solid #94a3b8;border-radius:16px;background:#eef2f7;overflow:hidden}',
      ...
      '#ulimAllClassesBoard735410 section[data-all-class-drop]>header span{margin-left:8px;white-space:nowrap}',
      '#ulimAllClassesBoard735410 section[data-all-class-drop] [data-all-student]{display:block!important;width:100%!important;min-width:0!important;max-width:100%!important;box-sizing:border-box!important;white-space:normal!important;overflow:hidden!important;overflow-wrap:anywhere!important;word-break:keep-all!important;line-height:1.45!important}',
      ...
      '@media(max-width:760px){#ulimAllClassesBoard735410{grid-auto-columns:minmax(285px,88vw)!important}#ulimAllClassesBoard735410>.ulim-all-teacher-column735411{min-width:285px;max-width:88vw}}'
    ].join('\n');
  ...
  function bindAllClassesSearchPicker735411() {
    ...
    if (grid) grid.style.gridTemplateColumns = '150px minmax(320px,1fr) auto';
  ...
  function bindAllClassesObserver735411() {
    ...
    allClassesObserver735411 = new MutationObserver(function (mutations) {
      for (var i = 0; i < mutations.length; i += 1) {
        ...
        if ((target && target.id === 'ulimAllClassesBoard735410') || document.getElementById('ulimAllClassesAttendanceModal735410')) {
          scheduleAllClassesEnhancement735411(20);
          break;
        }
      }
