(function (global) {
  ...
  if (global.__ULIM_ATTENDANCE_ADMIN_INTEGRATED_735432__) return;
  ...
  global.ULIM_ATTENDANCE_ADMIN_INTEGRATED_VERSION = '2026-08-10.735.04.32-r15-roster-sync-fix';

  var VERSION = '2026-08-10.735.04.32-r15-roster-sync-fix';
  var loadSequence = 0;
  ...
  function renderAllClassesBoardLocal735410() {
    ...
    var groups = (ledger.groups || []).filter(function (group) { return teacher === 'all' || normalize(group.instructorName) === teacher; }).sort(wholeClassGroupCompare735432);
    if (!groups.length) {
