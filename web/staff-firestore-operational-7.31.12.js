(function (global) {
  ...
  if (global.__ULIM_STAFF_FIRESTORE_OPERATIONAL_73112__) return;
  global.__ULIM_STAFF_FIRESTORE_OPERATIONAL_73112__ = true;

  const VERSION = '2026-07-31.731.12';
  const CACHE_PREFIX = 'ulim_staff_fsop_73112_';
